...
/*
 * @FilePath: \startup-monorepo\packages\composables\use-lock-scroll.ts
 * @Description: use-lock-scroll
 */
...
export const useLockScroll = (trigger: Ref<boolean>) => {
  ...
  watch(trigger, (val) => {
    ...
    const bodyOverflowY = document.defaultView?.getComputedStyle(document.body).overflowY
