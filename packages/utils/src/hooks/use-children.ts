/*
 * @FilePath: \startup-monorepo\packages\composables\use-children.ts
 * @Description: use-children
 */
import { type ComponentInternalInstance, type VNode, type VNodeNormalizedChildren, isVNode, shallowRef } from 'vue'
